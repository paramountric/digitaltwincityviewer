...
import { Tileset3D, Tile3D, TILE_TYPE } from '../../loaders/tiles/index.js';
...
export type Tile3DLayerProps<DataT = any> = _Tile3DLayerProps<DataT> &
...
export default class Tile3DLayer<
  DataT = any,
  ExtraPropsT = any
> extends CompositeLayer<ExtraPropsT & Required<_Tile3DLayerProps<DataT>>> {
  ...
  // todo: find the TS setting to include inherited members (from composite layer)
  id: any;
  props: any;
  internalState: any;
  setChangeFlags: any;

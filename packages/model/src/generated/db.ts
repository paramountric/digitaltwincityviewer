  ...
  public: {
    Tables: {
      ...
      automation_function_runs: {
        ...
        Relationships: [
          {
            foreignKeyName: "automation_function_runs_automationrunid_foreign"
            columns: ["automationRunId"]
            isOneToOne: false
            referencedRelation: "automation_runs"
            referencedColumns: ["automationRunId"]
          },
        ]
      }
      automation_function_runs_result_versions: {
        ...
        Relationships: [
          {
            foreignKeyName: "automation_function_runs_result_versions_automationrunid_functi"
            columns: ["automationRunId", "functionId"]
            isOneToOne: false
            referencedRelation: "automation_function_runs"
            referencedColumns: ["automationRunId", "functionId"]
          },
          {
            foreignKeyName: "automation_function_runs_result_versions_resultversionid_foreig"
            columns: ["resultVersionId"]
            isOneToOne: false
      ...
      automation_runs: {
        ...
        Relationships: [
          {
            foreignKeyName: "automation_runs_automationid_automationrevisionid_foreign"
            columns: ["automationId", "automationRevisionId"]
            isOneToOne: false
            referencedRelation: "automations"
            referencedColumns: ["automationId", "automationRevisionId"]
          },
          {
            foreignKeyName: "automation_runs_versionid_foreign"
            columns: ["versionId"]
            isOneToOne: false
            referencedRelation: "commits"
            referencedColumns: ["id"]
      ...
      automations: {
        ...
        Relationships: [
          {
            foreignKeyName: "automations_modelid_foreign"
            columns: ["modelId"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "automations_webhookid_foreign"
            columns: ["webhookId"]
            isOneToOne: false

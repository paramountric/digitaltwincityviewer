...
interface InteractionContext {
  ...
  clearErrors: () => void;
  setEditMode: (
    mode: ViewMode | DrawPolygonMode | DrawPointMode | DrawLineStringMode
  ) => void;

  // todo: add all the methods here
}

const InteractionContext = createContext<InteractionContext | undefined>(
  undefined
);

export const InteractionProvider: React.FC<{ children: React.ReactNode }> = ({
  children,
}) => {

...
export class Viewport {
  ...
  constructor(viewportProps: ViewportProps) {
    ...
    mainFeature.properties._rotationOrbit =
      mainFeature.properties._rotationOrbit ?? 0;
    mainFeature.properties._rotationX = mainFeature.properties._rotationX ?? 0;
    mainFeature.properties._target = mainFeature.properties._target ?? [
      0, 0, 0,
    ];
  ...
  getViews(): any {
    ...
    const views = [
      this.mainLayout.getView({
        view3d: this.mainLayout.numFeatures() > 0 ? true : false,
  ...
  setMainViewState(viewState: MapViewState) {
  ...
  applyFeatures(features: Feature[]) {
    this.mainLayout.applyFeatures(features);
    this.update();
  }
}

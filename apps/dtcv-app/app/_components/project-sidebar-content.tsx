...
import { ArrowDownToDot, ChevronRight, LocateFixedIcon, PinIcon } from 'lucide-react';
import { DEFAULT_MAP_COORDINATES } from '@/viewport';
              ...
              <SidebarMenuSub>
                <SidebarMenuSubItem key={'longitude'}>
                  <SidebarMenuSubButton className="hover:bg-inherit">
                    <ArrowDownToDot />
                    <span>Lon {project.properties?.longitude ?? DEFAULT_MAP_COORDINATES[0]}</span>
                  </SidebarMenuSubButton>
                </SidebarMenuSubItem>
                <SidebarMenuSubItem key={'latitude'}>
                  <SidebarMenuSubButton className="hover:bg-inherit">
                    <ArrowDownToDot />
                    <span>Lat {project.properties?.latitude ?? DEFAULT_MAP_COORDINATES[1]}</span>
                  </SidebarMenuSubButton>
                </SidebarMenuSubItem>

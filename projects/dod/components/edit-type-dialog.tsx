...
import ImportDataWizard from './import-data-wizard';

export default function EditTypeDialog() {
  const {
    state,
    actions: { setShowEditTypeDialog },
  } = useUi();

  return (
    <Transition.Root show={state.showEditTypeDialog} as={Fragment}>
      <Dialog
        as="div"
        className="relative z-50"
        onClose={() => setShowEditTypeDialog(false)}
      >
        <Transition.Child
          as={Fragment}

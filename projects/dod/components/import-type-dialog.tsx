...
import ImportTypeWizard from './import-type-wizard';
...
export default function ImportTypeDialog() {
  ...
  return (
    <Transition.Root show={state.showImportTypeDialog} as={Fragment}>
      <Dialog
        as="div"
        className="relative z-50"
        onClose={() => setShowImportTypeDialog(false, null)}
      >
        <Transition.Child
          as={Fragment}
              ...
              <Dialog.Panel className="md:max-w-7xl md:mx-10 relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
                {/*<div className="absolute top-0 right-0 hidden pt-4 pr-4 sm:block">
                  <button
                    ...
                    onClick={() => setShowImportTypeDialog(false)}
                  >

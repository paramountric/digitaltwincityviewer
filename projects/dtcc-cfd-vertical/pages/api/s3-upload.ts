...
// following code is eventually for later when the viewer server needs to store and process the file intermediately
// currently the file is uploaded directly to S3 by the next-s3-upload library

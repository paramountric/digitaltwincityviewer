...
export default class InteractionManager {
  ...
  onClick(info) {
    if (!info.object || !info.object.setState) {
      return;
    }

    info.object.setState(NODE_STATE.SELECTED);
  ...
  _mouseLeaveNode() {
    if (this._lastHoveredNode.object.state === 'selected') {
      return;
    }

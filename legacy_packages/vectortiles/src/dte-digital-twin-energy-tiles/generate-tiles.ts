...
export async function generateTiles() {
  ...
  const data = {
    ...
    grid100m2018: shortenPropertyNames(grid100m2018),
    grid100m2050: shortenPropertyNames(grid100m2050),
    cityDistricts2018: shortenPropertyNames(cityDistricts2018),
    cityDistricts2050: shortenPropertyNames(cityDistricts2050),
    baseAreas2018: shortenPropertyNames(baseAreas2018),
    baseAreas2050: shortenPropertyNames(baseAreas2050),
    primaryAreas2018: shortenPropertyNames(primaryAreas2018),
    primaryAreas2050: shortenPropertyNames(primaryAreas2050),
    water: prepareWater(),
    roads: prepareRoads(),
    trees: prepareTrees(),
  };
